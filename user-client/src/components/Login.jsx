...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!signIn) {
      body.confirmPass = formData.get("confirmPass");
    }
    ...
    return (
      <div className="mainContainer">
        <div className="containerA">
          ...
          <svg className="googleIcon" viewBox="0 0 128 128">
            <path
              fill="#fff"
        ...
        <div className="containerB">
          ...
          <div onClick={() => setSignIn(false)} className="button1">
            <button>Join</button>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="mainContainer">
        <div className="containerA">
          ...
          <h2>Or create an account with an email</h2>
          <form onSubmit={handleSubmit}>
            <input
              type="text"
              name="email"
        ...
        <div className="containerB">
          <h2 className="heading2">Already have an account?</h2>
          <div onClick={() => setSignIn(true)} className="button1">
